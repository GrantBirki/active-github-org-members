...
class GitHub
  ...
  #     app_key: "<escaped-pem-private-key>"
  #   )
  #
  ...
  # @note When using environment variables for keys, ensure newlines are escaped in a single line string
  def initialize(log: nil, app_id: nil, installation_id: nil, app_key: nil, app_algo: nil)
    ...
    # make sure this key in your env is a single line string with escaped newlines
